...
GRANT ALL ON WSO2IDP_COMMON_DB.* TO '{{ .Values.global.celleryRuntime.db.carbon.username }}'@'%' IDENTIFIED BY '{{ .Values.global.celleryRuntime.db.carbon.password }}';
GRANT ALL ON WSO2IDP_IDENTITY_DB.* TO '{{ .Values.global.celleryRuntime.db.carbon.username }}'@'%' IDENTIFIED BY '{{ .Values.global.celleryRuntime.db.carbon.password }}';
GRANT ALL ON WSO2IDP_CONSENT_DB.* TO '{{ .Values.global.celleryRuntime.db.carbon.username }}'@'%' IDENTIFIED BY '{{ .Values.global.celleryRuntime.db.carbon.password }}';
