...
GRANT ALL ON WSO2AM_COMMON_DB.* TO '{{ .Values.global.celleryRuntime.db.carbon.username }}'@'%' IDENTIFIED BY '{{ .Values.global.celleryRuntime.db.carbon.password }}';
GRANT ALL ON WSO2AM_APIMGT_DB.* TO '{{ .Values.global.celleryRuntime.db.carbon.username }}'@'%' IDENTIFIED BY '{{ .Values.global.celleryRuntime.db.carbon.password }}';
GRANT ALL ON WSO2AM_STAT_DB.* TO '{{ .Values.global.celleryRuntime.db.carbon.username }}'@'%' IDENTIFIED BY '{{ .Values.global.celleryRuntime.db.carbon.password }}';
