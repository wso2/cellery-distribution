...
<%@include file="localize.jsp" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <!-- content -->
            <div class="container col-xs-10 col-sm-10 col-md-6 col-lg-4 col-centered wr-content wr-login col-centered">
                <div class="padding-top-double">
                    <h2 class="wr-title uppercase grey-bg white top-header"><%=Encode.forHtmlContent(stat)%> </h2>
                </div>
