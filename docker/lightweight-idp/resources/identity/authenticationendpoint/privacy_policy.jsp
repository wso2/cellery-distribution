        ...
        <div class="container col-xs-12 col-sm-12 col-md-12 col-lg-12 col-centered wr-content wr-login col-centered padding-bottom-100">
            ...
            <div class="boarder-all ">
                ...
                <div id="privacyPolicy" class="padding-double">
                    <h4><strong>About WSO2 Identity Server</strong></h4>
                        <p><a href="http://wso2.org/library/identity-server">WSO2 Identity Server</a> (referred to as &ldquo;WSO2 IS 5.5.0&rdquo; within this policy) is an open source Identity Management and Entitlement Server that is based on open standards and specifications.</p>
